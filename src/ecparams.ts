...
class P256ECGroupParams implements ECGroupParams {
    descGq = ECGroup.P256;
    Gq = new Group(this.descGq);
    oid = "1.3.6.1.4.1.311.75.1.2.2";
    g = [
    this.Gq.parsePoint([
...
class P384ECGroupParams implements ECGroupParams {
    descGq = ECGroup.P384; 
    Gq = new Group(this.descGq);
    oid = "1.3.6.1.4.1.311.75.1.2.2";
    g = [
...
class P521ECGroupParams implements ECGroupParams {
    descGq = ECGroup.P521; 
    Gq = new Group(this.descGq);
    oid = "1.3.6.1.4.1.311.75.1.2.3";
    g = [	
        this.Gq.parsePoint([
...
export function getEcGroup(descGq: ECGroup): ECGroupParams {
